...
public class BasicGameApp implements Runnable, KeyListener {
    ...
    public BasicGameApp() {
        ...
        //0.0001-0.9999
        //0.001 - 9.999
        // 0-9 only takes the whole number no rounding

        // range 1-10
        //randx = (int)(Math.random()*10) + 1;
        // goes from 0-9 to 1-10
...
// put your code to do things here.
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == 37) { //up arrow pressed
            System.out.println("going left");
            astro.dx = -Math.abs(astro.dx);
        }
        if (e.getKeyCode() == 39) { //up arrow pressed
            System.out.println("going right");
            astro.dx = Math.abs(astro.dx);
        }
        if (e.getKeyCode() == 40) { //up arrow pressed
    ...
    public void keyReleased(KeyEvent e) {
        System.out.println("i stop touching" + e.getKeyCode());
        if (e.getKeyCode() ==38){
